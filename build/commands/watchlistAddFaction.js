...
module.exports.run = async (msg, args, client, db, ID) => {
    ...
    if(args.length > 4) return msg.reply("ERR: Too many parameters. Please provide no more than three words to the faction name")
    ...
    db.addFactionToWatchList(ID, one, two)
        .then((res) => {
...
Note: You do not need to remember this code. You can remove a faction at any time with list.factionremove tag`);
        })
        .catch((err) => {
